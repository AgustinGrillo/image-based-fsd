...
# Load model
generator_model = tf.keras.models.load_model('gan_models/model_test_320x640_blank_dataset_V1/generator_model_epoch_180')

# Load image
# test_img_path = 'dataset_images/data_set_2/training_set/Noise/mid22/mid22_6.jpg'
test_img_path = 'dataset_images/real_test_images/prototype/WhatsApp Image 2022-02-27 at 11.07.17 AM.jpeg'
