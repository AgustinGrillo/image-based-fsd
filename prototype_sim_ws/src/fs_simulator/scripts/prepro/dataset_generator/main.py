...
# Set model paths
path_floor = PATH_fs_simulator + "/meshes/asphalt/materials/textures/"
path_blue = PATH_fs_simulator + "/models/cone_blue/materials/textures/"
path_yellow = PATH_fs_simulator + "/models/cone_yellow/materials/textures/"
path_orange = PATH_fs_simulator + "/models/cone_orange_big/materials/textures/"
# Gazebo world path
path_world = PATH_fs_simulator + "/worlds/track_def.world"
# URDF path
path_urdf = PATH_fs_simulator + "/urdf/prototype.urdf.xacro"
# Track Model Path
path_track_model_mod = PATH_fs_simulator + "/models/track/prototype_track_gan_mod.sdf"
path_track_model_mod_base = PATH_fs_simulator + "/models/track/prototype_track_gan_mod_backup.sdf"
...
for iter_num in range(1, 200):
    ...
    while line_track:
        ...
        if line_track.strip().startswith('<pose>'):
            ...
            radius = np.random.triangular(0, 0.13, 0.2)
    ...
    noise_stdv = np.random.uniform(0, 0.03, 1)
