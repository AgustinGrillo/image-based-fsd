...
import rospy
import rospkg
from scripts.other_scripts.openai_ros_common import StartOpenAI_ROS_Environment


if __name__ == '__main__':

    rospy.init_node('fssimulator_maze_qlearn', anonymous=True, log_level=rospy.WARN)
