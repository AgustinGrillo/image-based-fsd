...
samples = []
with open('/home/agus/ros/fss_ws/src/imitation_learning/output/interpolated.csv') as csvfile:
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                if batch_sample[5] != "filename":
                    ...
                    name = '/home/agus/ros/fss_ws/src/imitation_learning/output/center/' + path[1].split(
                        '\\')[-1]
