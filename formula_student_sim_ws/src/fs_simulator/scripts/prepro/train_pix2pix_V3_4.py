...
def load_images(imagePath):
    ...
    img_num = img_num[-2]
    mid = mid[-2]
    target_path = '/home/agus/Documents/Proyectos/fs_itba/src/fs_simulator/scripts/prepro/dataset_images/'+DATASET+'/training_set/Target_Simplified/' + mid + '/' + img_num + '.jpg'
