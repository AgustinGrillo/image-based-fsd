...
def generate_real_samples(dataset, n_samples, patch_shape):
    ...
    y = ones((n_samples, patch_shape, 40*patch_shape/12, 1))    ## HARD-CODED  <-------------------------------------------------------
    return [X1, X2], y
...
def generate_fake_samples(g_model, samples, patch_shape):
    ...
    y = zeros((len(X), patch_shape, 40*patch_shape/12, 1))    ## HARD-CODED  <-------------------------------------------------------
    return X, y
...
# load image data
dataset = load_real_samples('dataset_images/data_set_2/dataset_compressed.npz')
