...
def load_images(imagePath):
    ...
    mid = mid[-2]
    target_path = '/home/agus/Documents/Proyectos/fs_itba/src/fs_simulator/scripts/prepro/dataset_images/'+DATASET+'/training_set/Target_Simplified/' + mid + '/' + mid + '_0.jpg'
    ...
    # pixels intensities to the range [0, 1]
    depth_path = '/home/agus/Documents/Proyectos/fs_itba/src/fs_simulator/scripts/prepro/dataset_images/'+DATASET+'/training_set/Target_Depth/' + mid + '/' + mid + '_0.npy'
