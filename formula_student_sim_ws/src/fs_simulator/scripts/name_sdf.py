...
def parser():
    ...
    fi = open('/home/agus/Documents/Proyectos/fs_itba/src/fs_simulator/models/track/track_3.sdf', 'r')
    fo = open('/home/agus/Documents/Proyectos/fs_itba/src/fs_simulator/models/track/track_3_mod.sdf', 'w')
